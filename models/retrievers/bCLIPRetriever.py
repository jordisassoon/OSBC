...
class bCLIPRetriever:
    ...
    @torch.no_grad()
    def predict(self, query, descriptions, images, encoded_sentences):
        ...
        return np.argmax(clip_text_similarity + clip_image_similarity + bert_similarity)
    ...
    def batch_predict(self, queries):
        ...
        return list(map(lambda x: self.predict(x, descriptions, images, sentences), queries))
